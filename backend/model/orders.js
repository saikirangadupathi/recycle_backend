...
const orders = new Schema({
    ...
    location: {
        ...
        address: { type: String, required: true } // Detailed location information
    },
    status: { type: String, required: false },
    priority: { type: String, enum: ['Low', 'Medium', 'High'], default: 'Medium' }, // New field for priority
    pickupAgentId: { type: String, required: false  }, // New field for assigned personnel
    pricing: { // New field for pricing details
