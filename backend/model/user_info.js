...
const orderHistorySchema = new Schema({
    ...
    paymentMethod: { type: String, required: false},  // Track payment method
    deliveryAddress: { type: addressSchema, required: false}, // Store delivery address used
...
const pickupHistorySchema = new Schema({
    ...
    status: { type: String, enum: ['Pending', 'Completed'], required: false}
});
